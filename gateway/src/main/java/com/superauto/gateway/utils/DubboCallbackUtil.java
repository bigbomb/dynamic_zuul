package com.superauto.gateway.utils;
...
public class DubboCallbackUtil {
    ...
    public static Object invoke(String interfaceName, String methodName,String jsonString, String address, String version) {
...
//            }
            ...
            Object resultParam = genericService.$invoke(methodName, getMethodParamType(interfaceName, methodName), new Object[] { jsonString });
            return resultParam;
        }
        return null;
    }
